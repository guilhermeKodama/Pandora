...
//***************************************************************
	...
	{	
		...
		float ganancia=5.0;
		float Vcc=3.3;
		float RefTension=2.39; // Voltage Reference of Wheatstone bridge.
		float Ra=6260.0; //Wheatstone bridge resistance.
		float Rc=4680.0; //Wheatstone bridge resistance.
		float Rb=411.0; //Wheatstone bridge resistance.
