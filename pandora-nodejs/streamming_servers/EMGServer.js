...
//Constructor
function EMGServer(DEVICE_ID,IN_PORT,OUT_PORT){
...
///class methods
EMGServer.prototype.connect = function(){
	...
	this.server.on("message",function(msg,rinfo){
		...
		if(this.oldData != temp){
			...
			this.httpSocketIo.sockets.emit('emg',String.fromCharCode.apply(null,new Uint16Array(msg)));
			//Log in console
			// console.log("ecg: "+msg);
		}
	...
	this.server.on("listening",function(){
		...
		console.log("EMG - listening "+ address.address + ":" + address.port);
		console.log("EMG - broadcasting to "+ address.address + ":" + this.portClient);
	}.bind(this));
