...
//Constructor
function BloodPressureServer(DEVICE_ID,IN_PORT,OUT_PORT){
...
///class methods
BloodPressureServer.prototype.connect = function(){
	...
	this.server.on("message",function(msg,rinfo){
		...
		if(this.oldData != temp){
			...
			this.httpSocketIo.sockets.emit('bloodpressure',String.fromCharCode.apply(null,new Uint16Array(msg)));
			//Log in console
			// console.log("ecg: "+msg);
		}
	...
	this.server.on("listening",function(){
		...
		console.log("BLOOD PRESSURE - listening "+ address.address + ":" + address.port);
		console.log("BLOOD PRESSURE - broadcasting to "+ address.address + ":" + this.portClient);
	}.bind(this));
...
//export the class
module.exports = BloodPressureServer;