...
//Constructor
function PatientPositionServer(DEVICE_ID,IN_PORT,OUT_PORT){
...
///class methods
PatientPositionServer.prototype.connect = function(){
	...
	this.server.on("message",function(msg,rinfo){
		...
		if(this.oldData != temp){
			...
			this.httpSocketIo.sockets.emit('patientposition',String.fromCharCode.apply(null,new Uint16Array(msg)));
			//Log in console
			// console.log("ecg: "+msg);
		}
	...
	this.server.on("listening",function(){
		...
		console.log("POSITION - listening "+ address.address + ":" + address.port);
		console.log("POSITION - broadcasting to "+ address.address + ":" + this.portClient);
	}.bind(this));
...
//export the class
module.exports = PatientPositionServer;