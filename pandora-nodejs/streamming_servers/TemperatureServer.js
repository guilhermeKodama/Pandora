...
//Constructor
function TemperatureServer(DEVICE_ID,IN_PORT,OUT_PORT){
...
///class methods
TemperatureServer.prototype.connect = function(){
	...
	this.server.on("message",function(msg,rinfo){
		...
		if(this.oldData != temp){
			...
			this.httpSocketIo.sockets.emit('temperature',String.fromCharCode.apply(null,new Uint16Array(msg)));
			//Log in console
			// console.log("ecg: "+msg);
		}
	...
	this.server.on("listening",function(){
		...
		console.log("TEMPERATURE - listening "+ address.address + ":" + address.port);
		console.log("TEMPERATURE - broadcasting to "+ address.address + ":" + this.portClient);
	}.bind(this));
